    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                       related_name='authorization_request', to='auth_token.authorizationtoken',
                                       verbose_name='authorization token'),
        ),
        migrations.AddField(
            model_name='authorizationrequest',
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                    related_name='authorization_requests', to='auth_token.mobiledevice',
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                       related_name='authorization_request', to='auth_token.onetimepassword',
                                       verbose_name='one time password'),
        ),
        migrations.AddField(
